...
export default function Home() {
  ...
  // Loading state
  if (dishListQuery.isPending) {
    return (
      <div className='flex items-center justify-center h-screen'>
        <Card className='w-full max-w-md p-6'>
          <CardHeader>
            <CardTitle className='text-xl text-center'>Đang tải...</CardTitle>
          </CardHeader>
          <CardContent>
            <p className='text-center'>Vui lòng chờ trong giây lát.</p>
          </CardContent>
        </Card>
      </div>
    );
      ...
      <div className='flex items-center justify-center h-screen'>
        <Card className='w-full max-w-md p-6'>
          ...
          <CardFooter className='flex justify-center'>
            <Button variant='outline' onClick={() => dishListQuery.refetch()}>
              Tải lại trang
            </Button>
          </CardFooter>
        </Card>
